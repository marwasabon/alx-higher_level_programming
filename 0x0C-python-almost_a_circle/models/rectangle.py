#!/usr/bin/python3
'''
This is a Python script that defines a Rectangle class that inherits from the Base class.
'''
...
def x(self, value):
    ...
    Args:
        value (int): The x-coordinate of the top-left corner of the rectangle.
...
def y(self, value):
    ...
    Args:
        value (int): The y-coordinate of the top-left corner of the rectangle.
